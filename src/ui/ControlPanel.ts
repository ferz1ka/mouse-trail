...
export class ControlPanel {
  ...
  render() {
    ...
    const shapeControls = this.createGroup("Shape & Size", [
      this.createSelect("Shape", "shape", [
        "Circle",
        "Triangle",
        "Square",
        "Star",
      ]),
      this.createRange("Size", "size", 1, 30, 1),
    ...
    const physicsControls = this.createGroup("Physics & Behavior", [
      this.createRange("Fade Speed", "delayFade", 0.001, 0.05, 0.001),
      this.createRange("Spread", "spread", 0, 10, 1),
      this.createRange("Base Speed", "speed", 0, 3, 0.1),
    ...
    const spawnControls = this.createGroup("Spawning Rules", [
      ...
      this.createCheckbox("Spawn on Hold", "spawnOnHold"),
      this.createCheckbox("Inherit Velocity", "inheritVelocity"),
      this.createRange("Inherit Factor", "inheritFactor", 0.1, 0.5, 0.01),
    ]);
